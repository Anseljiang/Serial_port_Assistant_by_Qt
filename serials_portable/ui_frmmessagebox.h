...
public:
    ...
    void setupUi(QDialog *frmMessageBox)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image/diamond.png"), QSize(), QIcon::Normal, QIcon::Off);
        frmMessageBox->setWindowIcon(icon);
        ...
        lab_Ico->setMinimumSize(QSize(32, 0));
        ...
        btnOk->setMaximumSize(QSize(90, 30));
    ...
    void retranslateUi(QDialog *frmMessageBox)
    {
        ...
        lab_Title->setText(QCoreApplication::translate("frmMessageBox", "\346\266\210\346\201\257", nullptr));
